...
export const ProfileCard: React.FC<{ className?: string }> = (props) => {
  const nameTextClassBase = `  font-extrabold text-tertiary sm:text-text-main`;
  return (
    <div
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row h-fit sm:gap-9">
        <div className="flex flex-col items-center">
          <p className={`text-text-sub   font-semibold`}>{myProfile.comment}</p>
        ...
        <div className="flex flex-col items-center sm:items-start mx-10">
          ...
          <div className="size-fit p-3">
            <p
              className={`  text-text-sub font-semibold text-[15px] sm:text-[20px] leading-4 sm:leading-5 whitespace-pre-wrap`}
            >
